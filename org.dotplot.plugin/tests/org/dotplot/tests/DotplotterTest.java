...
//	      assertSame("prüft ob beim zweiten aufruf das gleich objekt zurück kommt", id, this.dp.getDotplot(true));
//	      this.dp.setFileList(df);
//	      assertNotNull(df);
//	      assertNotSame("prüft ob beim zweiten aufruf nicht das gleich objekt zurück kommt", id, this.dp.getDotplot(true));
//	   }
//	   catch(Exception e){
