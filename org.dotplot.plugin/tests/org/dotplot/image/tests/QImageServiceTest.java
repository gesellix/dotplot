...
public class QImageServiceTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.image.QImageService.workingContextIsCompatible(Class)'
	 */
	public void testWorkingContextIsCompatible() {
		...
		assertFalse(this.service.workingContextIsCompatible(TokenStreamContext.class));		
	}
	...
	/*
	 * Test method for 'org.dotplot.image.QImageService.registerDefaultConfiguration(IConfigurationRegistry)'
	 */
