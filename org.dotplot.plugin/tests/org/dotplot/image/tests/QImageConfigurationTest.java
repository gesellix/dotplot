 ...
 * 
 */
public class QImageConfigurationTest extends TestCase {
	...
	public void testSerializedForm(){
		assertEquals("false;1;/dotplot;true;inverted_gray;-1;-16777216;1;true;true;true", this.config.serializedForm());
	}
	...
	public void testObjectForm(){
		...
		try {
			this.config.objectForm("false;1;/dotplot;true;inverted_gray;-1;-1d6777216;1;true;true;true");
			fail("IllegalArgumentException must be thrown");
		}
		catch (IllegalArgumentException e) {
			/*all clear*/
		...
		IConfiguration copy = this.config.objectForm("false;1;/dotplot;true;inverted_gray;-1;-16777216;1;true;true;true");
		assertNotNull(copy);
		assertTrue(copy instanceof QImageConfiguration);
		QImageConfiguration config = (QImageConfiguration) copy;
