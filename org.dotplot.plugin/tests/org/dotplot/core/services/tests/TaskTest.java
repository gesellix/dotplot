...
public class TaskTest extends TestCase {
	...
	private class TestJobPart implements ITaskPart {
		...
		/* (non-Javadoc)
		 * @see org.dotplot.services.IJobPart#setErrorHandler(org.dotplot.services.IProcessingErrorHandler)
		 */
		...
		/* (non-Javadoc)
		 * @see org.dotplot.services.IJobPart#setLocalRessources(java.util.Collection)
		 */
