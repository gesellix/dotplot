...
public class InsufficientRessourcesExceptionTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.services.InsufficientRessourcesException.InsufficientRessourcesException()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.services.InsufficientRessourcesException.InsufficientRessourcesException(String)'
	 */
	public void testInsufficientRessourcesExceptionString() {
		Exception e; 
		e = new InsufficientRessourcesException(null);
		assertNull(e.getMessage());
		e = new InsufficientRessourcesException("org.dotplot.services.testService");
