...
public class IllegalContextExceptionTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.services.IllegalContextException.IllegalContextException(IContext)'
	 */
	public void testIllegalContextException() {
		...
		//the masseage is based on the on-the-fly implementation of the IContext interface
