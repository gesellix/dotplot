 ...
 * 
 */
public final class ServiceHotSpotTest extends TestCase {
	...
	public void testAddGetAllExtentions() {
		...
		ServiceHotSpot spot = new ServiceHotSpot(
				"org.dotplot.services.testspot", String.class);
	...
	/*
	 * Test method for
	 * 'org.dotplot.services.ServiceHotSpot.isValidExtention(Class)'
	 */
	public void testIsValidExtentionClass() {
		ServiceHotSpot spot = new ServiceHotSpot(
				"org.dotplot.services.testspot", Number.class);
		try {
	...
	/*
	 * Test method for
	 * 'org.dotplot.services.ServiceHotSpot.isValidExtention(Extention)'
	 */
	public void testIsValidExtentionExtention() {
		...
		ServiceHotSpot spot = new ServiceHotSpot(
				"org.dotplot.services.testspot", Throwable.class);
		try {
		...
		try {
			...
			assertTrue("test inheritance", spot.isValidExtention(new Extention(
					plugin, x)));
			assertFalse(spot.isValidExtention(new Extention(plugin,
					new Object())));
		}
		catch (Exception e) {
			fail("no exception");
	...
	/*
	 * Test method for
	 * 'org.dotplot.services.ServiceHotSpot.ServiceHotSpot(String, Class)'
	 */
