...
public class ServiceManagerTest extends TestCase {
	...
	private class ServiceTestImpl implements IService{
		...
		public void setWorkingContext(IContext context) throws IllegalContextException {}
		...
		/* (non-Javadoc)
		 * @see org.dotplot.services.IService#addExtention(java.lang.String, org.dotplot.services.Extention)
		 */
		public void addExtention(String serviceHotSpotID, Extention extention) throws UnknownServiceHotSpotException {
			// TODO Auto-generated method stub
		 ...
		 */
		public void addExtention(String serviceHotSpotID, IServiceExtentionActivator plugin, Object extentionObjection) throws UnknownServiceHotSpotException {
			// TODO Auto-generated method stub
	...
	/*
	 * Test method for 'org.dotplot.services.ServiceManager.registerService(IService)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.services.ServiceManager.unRegisterService(String)'
	 */
	public void testUnRegisterServiceString() {
		...
		assertFalse(this.manager.getAll().isEmpty());
		assertSame(this.service1, this.manager.unregister(this.service1.getID()));
		assertTrue(this.manager.getAll().isEmpty());
	}
