 ...
 *
 */
public class DefaultTaskProcessorTest extends TestCase {
	...
	private class TestTaskPart implements ITaskPart {
		 ...
		 */
		public void run() {
			if(this.causeException) throw new RuntimeException("exception caused"); 
		}
	...
	/*
	 * Test method for 'org.dotplot.services.DefaultTaskProcessor.setErrorHandler(IProcessingErrorHandler)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.services.DefaultTaskProcessor.processTask(ITask)'
	 */
	public void testProcessTask() {
		...
		assertEquals("[1](fatal) at TaskProcessor:no id -> java.lang.RuntimeException:exception caused\n", handler.getErrorMessages());
		...
		assertEquals("result:part1result:part2result:part3", this.processor.getTaskResult());
		assertNull(this.processor.getInvokingObject());
	}

	/*
	 * Test method for 'org.dotplot.services.DefaultTaskProcessor.getTaskResult()'
	 */
