...
public class DirectoryRessourceTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.ressources.DirectoryRessource.DirectoryRessource(File)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.ressources.DirectoryRessource.DirectoryRessource(String)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.ressources.DirectoryRessource.getInputStream()'
	 */
	...
	public void testGetURL() {
		try {
			...
			assertEquals(this.dir.toURL(), this.dr.getURL());			
		}
		catch (Exception e) {
			fail("no exception:" + e.getClass().getName() + ":"
					+ e.getMessage());
