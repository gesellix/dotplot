 ...
 *
 */
public class PluginJarFileTest extends TestCase {

	private File with, without, dir;
	...
	public void testPluginJarFileString() {
		try {
			new PluginJarFile(this.dir.getAbsolutePath(), null);
		...
		try {
			new PluginJarFile(this.with.getAbsolutePath(), this.context.getPluginSchema());
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	/*
	 * Test method for 'org.dotplot.core.PluginJarFile.PluginJarFile(String, boolean)'
	 */
	public void testPluginJarFileStringBoolean() {
		try {
			new PluginJarFile(this.dir.getAbsolutePath(),this.context.getPluginSchema(), true);
			fail("ZipException must be thrown");
		}
		catch (ZipException e) {
			/*all clear*/
		...
		try {
			new PluginJarFile(this.without.getAbsolutePath(),this.context.getPluginSchema(), true);
			fail("IllegalArgumentException must be thrown");
		}
		catch (IllegalArgumentException e) {
			/*all clear*/
		...
		try {
			new PluginJarFile(this.with.getAbsolutePath(),this.context.getPluginSchema(), true);
		}
		catch (Exception e) {
			fail("no exception:" + e.getClass().getName() + ":"
					+ e.getMessage());
	...
	public void testPluginJarFileFile() {
		try {
			new PluginJarFile(this.dir,this.context.getPluginSchema());
			fail("ZipException must be thrown");
		}
		catch (ZipException e) {
			/*all clear*/
	...
	/*
	 * Test method for 'org.dotplot.core.PluginJarFile.PluginJarFile(File, boolean)'
	 */
	public void testPluginJarFileFileBoolean() {
		try {
			new PluginJarFile(this.dir,this.context.getPluginSchema(), true);
			fail("ZipException must be thrown");
		}
		catch (ZipException e) {
			/*all clear*/
		...
		try {
			new PluginJarFile(this.without,this.context.getPluginSchema(), true);
			fail("IllegalArgumentException must be thrown");
		}
		catch (IllegalArgumentException e) {
			/*all clear*/
	...
	/*
	 * Test method for 'org.dotplot.core.PluginJarFile.getPluginXMLInputStream()'
	 */
