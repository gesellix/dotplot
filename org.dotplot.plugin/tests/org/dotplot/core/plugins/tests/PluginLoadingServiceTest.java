...
public class PluginLoadingServiceTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.service = new PluginLoadingService("org.dotplot.core.test.pluginloader");
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginLoadingService.PluginLoadingService(String)'
	 */
	public void testPluginLoadingService() {
		assertNotNull(this.service.getResultContext());
		assertSame(NullContext.class, this.service.getResultContext().getClass());
		assertNull(this.service.createTask());
	}

	/*
	 * Test method for 'org.dotplot.core.plugins.PluginLoadingService.workingContextIsCompatible(Class)'
	 */
	public void testWorkingContextIsCompatible() {
		try {
			...
			assertTrue(this.service.workingContextIsCompatible(PluginContext.class));
		}
		catch (Exception e) {
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginLoadingService.getResultContext()'
	 */
	public void testGetResultContext() {
		...
		try {
			...
			IPluginListContext result = (IPluginListContext)this.service.getResultContext();
			assertEquals(1, result.getPluginList().size());
			for(IPlugin p : result.getPluginList()){
				assertEquals("testplugin", p.getName());
				assertNotNull(p.getExtentions().get("org.dotplot.core.pluginloader").get("object2"));
				for(Extention e : p.getExtentions().get("org.dotplot.core.pluginloader").get("object2")){
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginLoadingService.getResultContextClass()'
	 */
	public void testGetResultContextClass() {
		assertSame(IPluginListContext.class, this.service.getResultContextClass());
	}

	/*
	 * Test method for 'org.dotplot.core.plugins.PluginLoadingService.createTask()'
	 */
