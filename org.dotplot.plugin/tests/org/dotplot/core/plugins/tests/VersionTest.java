...
public class VersionTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.services.Version.Version(String, VersionPattern)'
	 */
	...
	public void testNormalizes(){
		try {
			...
			assertEquals("50.10.10 alpha 3", new Version("050.10.10.0.0 alpha 03").normalize());
		}
		catch (MalformedVersionException e) {
			fail("no exception!");
		}
	...
	public void testCompareTo() {
		...
		try {
			vers = new Version[]{
			 ...
			 new Version("1.02"),
			 new Version("1.2.3 alpha 1"),
			 new Version("1.2.3 alpha 3"),
			 new Version("1.20"),
			};
