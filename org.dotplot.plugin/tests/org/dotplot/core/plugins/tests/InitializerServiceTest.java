 ...
 *
 */
public class InitializerServiceTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.context.getServiceRegistry().register("testservice", new TestService("testservice"));
	}

	/*
	 * Test method for 'org.dotplot.core.plugins.InitializerService.workingContextIsCompatible(Class)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.InitializerService.getResultContext()'
	 */
	public void testGetResultContext() {
		try {
			assertNull(this.service.getResultContext());
			assertFalse(((TestService)this.context.getServiceRegistry().get("testservice")).isInitialized());
			...
			assertTrue(((TestService)this.context.getServiceRegistry().get("testservice")).isInitialized());
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.InitializerService.getResultContextClass()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.InitializerService.createTask()'
	 */
