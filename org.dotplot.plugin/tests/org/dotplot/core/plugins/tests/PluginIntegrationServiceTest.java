...
public class PluginIntegrationServiceTest extends TestCase {
	...
	protected void setUp() throws Exception {	
		super.setUp();
		this.service = new PluginIntegrationService("org.dotplot.core.pluginintegration");
		this.context = new PluginContext(".", "./testfiles/core/");
		this.service.setFrameworkContext(this.context);
	}

	/*
	 * Test method for 'org.dotplot.core.plugins.PluginIntegrationService.workingContextIsCompatible(Class)'
	 */
	public void testWorkingContextIsCompatible() {
		assertTrue(this.service.workingContextIsCompatible(IPluginListContext.class));
	}	

	/*
	 * Test method for 'org.dotplot.core.plugins.PluginIntegrationService.getResultContext()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginIntegrationService.getResultContextClass()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginIntegrationService.createTask()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.plugins.PluginIntegrationService.PluginIntegrationService(String)'
	 */
	...
	public void testRun(){				
		try {
			assertFalse(this.context.getPluginRegistry().getAll().containsKey("testplugin"));
			this.service.setFrameworkContext(this.context);
			this.service.setWorkingContext(this.workingContext);
			this.service.run();
			assertTrue(this.context.getPluginRegistry().getAll().containsKey("testplugin"));
		}
		catch (Exception e) {
			fail("no exception:" + e.getClass().getName() + ":"
					+ e.getMessage());
