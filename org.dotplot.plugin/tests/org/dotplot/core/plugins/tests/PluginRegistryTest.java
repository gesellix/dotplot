 ...
 * 
 */
public final class PluginRegistryTest extends TestCase {
	...
	private class TestPlugin implements IPlugin {
		 ...
		 * 
		 * @see
		 * org.dotplot.core.services.IServiceExtentiontActivator#isActivated()
		 */
		 ...
		 * 
		 * @see
		 * org.dotplot.core.plugins.IPlugin#storeExtention(java.lang.String,
		 * org.dotplot.core.services.Extention)
		 */
		public void storeExtention(String serviceID, String hotSotID,
				Extention extention) {
		}
	...
	/*
	 * Test method for
	 * 'org.dotplot.core.plugins.PluginRegistry.PluginRegistry()'
	 */
	...
	/*
	 * Test method for
	 * 'org.dotplot.core.plugins.PluginRegistry.registerPlugin(P)'
	 */
	...
	/*
	 * Test method for
	 * 'org.dotplot.core.plugins.PluginRegistry.unregisterPlugin(String)'
	 */
