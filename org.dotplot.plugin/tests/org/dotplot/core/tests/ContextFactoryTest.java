...
public class ContextFactoryTest extends TestCase {
	...
	public void testGetContext() {
		...
		assertTrue(services.getAll().containsKey(CoreSystem.SERVICE_INTEGRATOR_ID));
		assertTrue(services.getAll().containsKey(CoreSystem.SERVICE_INITIALIZER_ID));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.Tokenizer"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.Filter"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.Converter"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.Converter"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.FMatrix"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.QImage"));
		assertTrue(services.getAll().containsKey("org.dotplot.standard.EclipseUI"));
		
		assertNotNull(context.getGuiServiceID());
		assertEquals("org.dotplot.standard.EclipseUI", context.getGuiServiceID());
		try {
		...
		try {
			...
			Map<String, ITokenizer> tokenizers =  tokenizerService.getRegisteredTokenizer();
		...
		assertEquals(CPlusPlusType.type, types.get("org.dotplot.types.Text.C++"));
