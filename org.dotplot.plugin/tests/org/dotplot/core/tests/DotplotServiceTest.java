 ...
 *
 */
public class DotplotServiceTest extends TestCase {
	...
	private class TestInterceptor implements IInterceptor {
		...
		public void execute(IPluginHotSpot hotSpot, DotplotService interceptedService, IContext workingContext, DotplotContext dotplotContext) {
	...
	private class TestDotplotService extends DotplotService{
	...
	public void testRun() {
		...
		try {
			...
			this.service.addExtention("org.dotplot.core.testservice.Before", active, interceptor);
			this.service.addExtention("org.dotplot.core.testservice.After", inactive, interceptor);
			
			PluginHotSpot spot = this.service.getHotSpot("org.dotplot.core.testservice.Before");
			assertEquals(1, spot.getAllExtentions().size());

			spot = this.service.getHotSpot("org.dotplot.core.testservice.After");
			assertEquals(1, spot.getAllExtentions().size());
