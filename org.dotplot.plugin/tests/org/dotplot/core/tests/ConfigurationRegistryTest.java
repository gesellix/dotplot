 ...
 *
 */
public class ConfigurationRegistryTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.core.ConfigurationRegistry.ConfigurationRegistry()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.ConfigurationRegistry.register(String, IConfiguration)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.ConfigurationRegistry.unregister(String)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.core.ConfigurationRegistry.combine(IRegistry<IConfiguration>)'
	 */
	...
	public void testCopy(){
		try {
			...
			assertTrue(registry.getAll().keySet().containsAll(this.registry.getAll().keySet()));
			
			for(String key: registry.getAll().keySet()){
				assertSame(registry.get(key).getClass(), this.registry.get(key).getClass());
			}
		}
		catch (Exception e) {
			fail("no exception:" + e.getClass().getName() + ":"
