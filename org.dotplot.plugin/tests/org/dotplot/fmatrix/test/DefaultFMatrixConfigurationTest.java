 ...
 * 
 */
public final class DefaultFMatrixConfigurationTest extends TestCase {
	...
	public void testCopy() {
		...
		try {
			IFMatrixConfiguration copy = (IFMatrixConfiguration) this.config
					.copy();
			assertNotSame(this.config.getManualWeightedTokens(), copy
					.getManualWeightedTokens());
			assertNotSame(this.config.getRegularExpressions(), copy
					.getRegularExpressions());

			assertEquals(this.config.getManualWeightedTokens().size(), copy
					.getManualWeightedTokens().size());
			assertEquals(this.config.getRegularExpressions().size(), copy
					.getRegularExpressions().size());
	...
	/*
	 * Test method for
	 * 'org.dotplot.fmatrix.DefaultFMatrixConfiguration.DefaultFMatrixConfiguration()'
	 */
	...
	/*
	 * Test method for
	 * 'org.dotplot.fmatrix.DefaultFMatrixConfiguration.getManualWeightedTokens()'
	 */
	...
	/*
	 * Test method for
	 * 'org.dotplot.fmatrix.DefaultFMatrixConfiguration.getRegularExpressions()'
	 */
