...
public class ConverterServiceTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterService.workingContextIsCompatible(Class)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterService.getResultContext()'
	 */
	public void testGetResultContext() {
		...
		try {			
			...
			File pdf1 = new File("./testfiles/converter/PO91-1999.pdf");
			File pdf2 = new File("./testfiles/converter/Zuordnung_Module_Schwerpunkte.pdf");
			...
			assertEquals(result1, file1.getFile().getCanonicalFile());
			assertEquals(txt.getCanonicalFile(), file2.getFile().getCanonicalFile());
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterService.getResultContextClass()'
	 */
	public void testGetResultContextClass() {
		assertSame(SourceListContext.class, this.service.getResultContextClass());
	}

	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterService.createTask()'
	 */
	public void testCreateTask() {
		...
		try {			
			...
			list.add(new DotplotFile("./testfiles/converter/PO91-1999.pdf", PdfType.type));
			list.add(new DotplotFile("./testfiles/converter/Zuordnung_Module_Schwerpunkte.pdf", PdfType.type));
			list.add(new DotplotFile("./testfiles/converter/pdfout.txt", TextType.type));
		
			this.service.setWorkingContext(context);
			
			task = this.service.createTask();
			if(task == null){
				System.out.println(((DefaultErrorHandler)this.service.getErrorHandler()).getErrorMessages());
			}
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterService.ConverterService(String)'
	 */
