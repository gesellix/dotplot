 ...
 *
 */
public class ConverterTaskPartTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.part = new ConverterTaskPart("part", this.converter, this.targetDir, true);
	}

	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterTaskPart.ConverterTaskPart(String)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterTaskPart.getResult()'
	 */
	public void testGetResult() {
		try {
			File destination = new File("./testfiles/converter/Zuordnung_Module_Schwerpunkte.pdf.txt");
			File source = new File("./testfiles/converter/Zuordnung_Module_Schwerpunkte.pdf");
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.converter.ConverterTaskPart.setLocalRessources(Collection<? extends IRessource>)'
	 */
