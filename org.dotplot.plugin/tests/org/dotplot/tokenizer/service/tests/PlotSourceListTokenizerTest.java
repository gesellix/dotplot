...
public class PlotSourceListTokenizerTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.PlotSourceStreamer.PlotSourceStreamer(ITokenizer)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.PlotSourceStreamer.addPlotSource(IPlotSource)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.tokenizer.PlotSourceStreamer.removePlotSource(IPlotSource)'
	 */
	...
	public void testGetStreamType(){		
		IPlotSource source1 = new DotplotFile("./testfiles/tokenizer/test.txt", JavaType.type);
		IPlotSource source2 = new DotplotFile("./testfiles/tokenizer/test.txt", PHPType.type);
		IPlotSource source3 = new DotplotFile("./testfiles/tokenizer/test.txt", TextType.type);
		IPlotSource source4 = new DotplotFile("./testfiles/tokenizer/test.txt", PdfType.type);
				
		ISourceList list = new DefaultSourceList();
		assertEquals(list.getCombinedSourceType(), this.streamer.getStreamType());
