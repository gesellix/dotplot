...
public class EclipseUIServiceTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.eclipse.EclipseUIService.workingContextIsCompatible(Class)'
	 */
	public void testWorkingContextIsCompatible() {
		...
		assertTrue(this.service.workingContextIsCompatible(FMatrixContext.class));
	}
	...
	/*
	 * Test method for 'org.dotplot.eclipse.EclipseUIService.getResultContextClass()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.eclipse.EclipseUIService.registerDefaultConfiguration(IConfigurationRegistry)'
	 */
	...
	/*
	 * Test method for 'org.dotplot.eclipse.EclipseUIService.EclipseUIService(String)'
	 */
