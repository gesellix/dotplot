...
public class FourGrammFilterTest extends TestCase {
	...
	/*
	 * Test method for 'org.dotplot.examples.FourGrammFilter.FourGrammFilter.getNextToken(ITokenStream)'
	 */
	public void testGetNextTokenITokenStream() {
		ITokenStream stream = new ITokenStream(){

			private Token[] tokens = {
					new Token("One", Token.TYPE_STRING),
		...
		assertEquals(new Token("One Two Three 4", Token.TYPE_STRING), this.filter.getNextToken(stream));
	...
	/*
	 * Test method for 'org.dotplot.examples.FourGrammFilter.FourGrammFilter.getNextToken()'
	 */
	public void testGetNextToken() {
		...
		assertEquals(new Token("One Two Three 4", Token.TYPE_STRING), filter.getNextToken());
	...
	/*
	 * Test method for 'org.dotplot.examples.FourGrammFilter.FourGrammFilter.filterToken(Token)'
	 */
	public void testFilterToken() {
		...
		assertEquals(new Token("One Two Three 4", Token.TYPE_STRING), filteredToken);
		...
		filteredToken = this.filter.filterToken(token4);
		assertNotNull(filteredToken);
		assertEquals(new Token("Three One . 4", Token.TYPE_STRING), filteredToken);
	...
	/*
	 * Test method for 'org.dotplot.examples.FourGrammFilter.FourGrammFilter.getStreamType()'
	 */
	...
	/*
	 * Test method for 'org.dotplot.examples.FourGrammFilter.FourGrammFilter.compareTo(ITokenFilter)'
	 */
