...
public class FourGrammFilter extends BaseTokenFilter {
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.filter.ITokenFilter#applyParameter(java.util.Map)
	 */
	public void applyParameter(Map<String, ? extends Object> parameter) {}

	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.filter.ITokenFilter#getNextToken(org.dotplot.tokenizer.service.ITokenStream)
	 */
