...
public final class DotplotCreator {
	...
	public static final String VM_PARAM_IMG_JAI_ENABLED = "image.highquality";

	public static final String VM_PARAM_GRID_MAXEDGE = "grid.maxedge";

	public static final String VM_PARAM_GRID_ENABLED = "grid.enabled";

	public static final String VM_PARAM_GRID_NOTIFY = "grid.notify";

	public static final String VM_PARAM_HEADLESS = "headless";
	...
	// /**
	// * Generiert einen Dotplot. Der Dotplot wird zwischengespeichert, und
	// wieder
	// * ausgegeben solange sich an den Einstellungen nichts geändert hat. Nur
	// bei
