...
public class Registry<C> implements IRegistry<C> {
	...
	/* (non-Javadoc)
	 * @see org.dotplot.services.IServiceManager#registerService(org.dotplot.services.IService)
	 */
	public C register(String id, C object) throws DuplicateRegistrationException{
		if(object == null || id == null) throw new NullPointerException();
		if(this.registry.containsKey(id)) throw new DuplicateRegistrationException(id);
		this.registry.put(id, object);
		return null;
	}

	/* (non-Javadoc)
	 * @see org.dotplot.services.IServiceManager#unRegisterService(java.lang.String)
	 */
	...
	public C get(String id) throws UnknownIDException {
		...
		if(object == null) throw new UnknownIDException(id);
		return object;
	}

	/* (non-Javadoc)
	 * @see org.dotplot.services.IServiceManager#combine(org.dotplot.services.IServiceManager)
	 */
	public void combine(IRegistry<C> registry) throws DuplicateRegistrationException {
