 ...
 * objects) and provides methods to access and modify data. <p/> The implemented
 * Hashtable will not take duplicate entries.
 * 
...
public class TypeTable implements Serializable, ITypeTable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.fmatrix.ITypeTable#addRegularExpressionType(java.lang.String,
	 *      double)
	 */
