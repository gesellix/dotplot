...
{
   /**
    * sets the current tokentype to the specified token type
    * and so enables user to access all needed data.
    * <p />
    * best Usage:
    * Match tempMatch
   ...
   /**
    * sets the threshhold for the frequency.
    * (when set, only tokentypes below this frequency will be considered.)
    *
    * @param frequency - the frequency threshhold. (set to 0 for not considering the threshhold.)
    */
    ...
    *
    * @param typeTable a TypeTable object specifying the new type table
    *
    * @see #getTypeTable
    */
