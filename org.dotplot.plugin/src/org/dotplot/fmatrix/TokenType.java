...
/**
 * this entity is used to store, modify and access a tokentype and all needed
 * information of this type for the fmatrix.
 * 
...
public class TokenType implements Serializable {
     ...
     * 
     * @param value
     *            - the string value for the tokentype.
     */
     ...
     * 
     * @param tokenIndex
     *            - the index of the position of this type.
     * 
	...
	// checking for previous occurrences is not neccessary for this
	// application.
    ...
    /**
     * returns the calculated weighting for a TokenType object according to its
     * frequency.
     * 
	...
	// return (1.0 / frequency) * 2; // x2, because one match consists of 2
	// positions.
     ...
     * 
     * @param index
     *            - get the match at position index.
     * 
     * @return Match - the Match.
     */
    public Match getMatch(int index) {
	return new Match(((Integer) (tokenPositions.get(index / frequency)))
		.intValue(), ((Integer) tokenPositions.get(index % frequency))
		.intValue(), getWeight());
	// getCalculatedWeight());
    }
	...
	for (int i = 0; i < getNumberOfMatches(); i++) {
	    toReturn += "                     " + "(x: "
		    + this.tokenPositions.get(i / this.frequency) + ","
