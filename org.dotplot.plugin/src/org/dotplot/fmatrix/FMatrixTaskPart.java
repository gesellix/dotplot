...
public class FMatrixTaskPart extends AbstractTaskPart {
	 ...
	 * @param stream
	 */
	public FMatrixTaskPart(String id, ITokenStream stream, IFMatrixConfiguration config) {
		super(id);
		if(stream == null || config == null) throw new NullPointerException();
	...
	/**
	 * Returns the <code>TokenStream</code> assiged to 
	 * this <code>FMatrixTaskPart</code>.
