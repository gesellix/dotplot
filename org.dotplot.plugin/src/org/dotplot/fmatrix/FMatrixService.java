...
public class FMatrixService extends DotplotService {
	...
	public ITask createTask() {
		...
		try {
			...
			IFMatrixConfiguration config = (IFMatrixConfiguration) this.frameworkContext
					.getConfigurationRegistry().get(ID_FMATRIX_CONFIGURATION);
			ITokenStream stream = ((TokenStreamContext) this
					.getWorkingContext()).getTokenStream();
	...
	public void registerDefaultConfiguration(IConfigurationRegistry registry) {
		...
		try {
			registry.register(ID_FMATRIX_CONFIGURATION,
