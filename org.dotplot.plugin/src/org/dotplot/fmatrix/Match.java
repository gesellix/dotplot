...
/**
 * represents a point of the fmatrix. Matching tokentypes are stored as a Match
 * object.
 * 
...
public class Match {
     ...
     * 
     * @param y
     *            - the y-Coordinate(-1 for not known)
     * @param x
     *            - the x-Coordinate(-1 for not known)
     * @param weight
     *            - the weight of this type
     */
