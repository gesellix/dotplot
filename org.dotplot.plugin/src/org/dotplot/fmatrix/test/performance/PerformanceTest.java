...
public class PerformanceTest
{
   ...
   public static void main(String args[])
   {
      ...
      //	 res1 = getter.getFromVector(vector, i);
      //res2 = getter.getFromArrayList(arrayList, i);

         // res3 = getter.getFromHashtable(hashtable, i);
         // res4 = getter.getFromHashMap(hashMap, i);
      }*/
   }
}
