...
public class TypeTableTest extends TestCase
{
   ...
   public void testAddRegularExpressionType()
   {
      ...
      /*typeIndex = typeTable.addRegularExpressionType("cat",0.5);
   ...
   {
      assertNotNull("navigator object must not be null!", this.typeTable.getNavigator());

      assertTrue("must return an ITypeTableNavigator", this.typeTable.getNavigator() instanceof ITypeTableNavigator);
   }
