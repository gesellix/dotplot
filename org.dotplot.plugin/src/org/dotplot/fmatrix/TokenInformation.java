...
public class TokenInformation implements Serializable {
     ...
     * 
     * @param container
     *            - the LineInformation object to add.
     */
	...
	while (fileInformationsIter.hasNext()) {
	    indices.add(new Integer(((SourceInformation) fileInformationsIter
		    .next()).getStartIndex()));
	}
	...
	while (fileInfoIter.hasNext()) {
	    SourceInformation fileInfo = (SourceInformation) fileInfoIter
		    .next();
	...
	return ((SourceInformation) fileInformations.elementAt(fileIndex))
		.getSourcename();
    }
	...
	return ((LineInformation) lineInformations.elementAt(fileIndex))
		.getLineIndex(index);
    }
