...
/**
 * Instances of this class are <code>Job</code>s to be excuted in system start
 * up.
 * <p>
 * The <code>InitializerService</code> is used to collect jobs which should be
 * executed on start up and executes them.
 * </p>
 * 
...
public class StartUpJob extends AbstractJob<DotplotContext> {
	 ...
	 */
	public final boolean validatePreconditions(final IServiceRegistry registry) {
		try {
