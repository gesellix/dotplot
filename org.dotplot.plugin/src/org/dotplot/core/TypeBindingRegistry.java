...
public class TypeBindingRegistry implements ITypeBindingRegistry {
	 ...
	 * @param typeRegistry The <code>TypeRegistry</code> for the <code>SourceTypes</code> to be bound.
	 * @throws NullPointerException if typeRegistry is <code>null</code>.
	 */
	public TypeBindingRegistry(ITypeRegistry typeRegistry) {
		super();
		if(typeRegistry == null) throw new NullPointerException();
	...
	public ISourceType getTypeOf(String ending) {
		if(ending == null) throw new NullPointerException();
