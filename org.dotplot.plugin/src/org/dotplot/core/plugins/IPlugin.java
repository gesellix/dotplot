...
public interface IPlugin extends IServiceExtentionActivator {
	...
	/**
	 * Returns the <code>JobRegistry</code> of the <code>Plugin</code>.
	 * The <code>JobRegistry</code> contains all <code>Job</code>s added 
	 * by the plugin.
	 ...
	 * @param status  
	 * 	<code>true</code> to activate> and <code>false</code> to deactivate
	 */
	 ...
	 * <p>
	 * An <code>Extention</code> must be assigned to a <code>Service</code>
	 * and a <code>HotSpot</code>.
	 * </p>
	 * @param serviceID - the id of the <code>Service</code> 
	 * @param hotSpotID - the id of the <code>HotSpot</code>
	 * @param extention - the <code>Extention</code> to store
	 */
	 ...
	 * <p>
	 * The <code>Extention</code>s are organized as a <code>Map</code> 
	 * of <code>Map</code>s of <code>Collection</code>s. The key of the 
	 * first <code>Map</code> is the serviceid and the key of the second 
