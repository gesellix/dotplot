...
public class PluginContext<P extends IPlugin> implements IPluginContext<P> {
	 ...
	 * 	- if <code>workingDirectory</code> does not represent an existing directory
	 */
	public PluginContext(String workingDirectory) {
		if(workingDirectory == null) throw new NullPointerException();
	 ...
	 * Creates a new <code>PluginContext</code>.
	 * @param workingDirectory The workingdirectory.
	 * @param pluginDirectory The plugindirectory.
	 * @throws NullPointerException 
	 * 	- if <code>workingDirectory</code> is <code>null</code>
	 * @throws NullPointerException 
	 ...
	 * 	- if <code>workingDirectory</code> does not represent an existing directory
	 * @throws IllegalArgumentException 
	 * 	- if <code>pluginDirectory</code> does not represent an existing directory
	 */
	public PluginContext(String workingDirectory, String pluginDirectory) {
		if(workingDirectory == null|| pluginDirectory == null) throw new NullPointerException();
	 ...
	 * @throws NullPointerException if <code>job</code> is <code>null</code>
	 */
	...
	/**
	 * Executes a <code>Job</code>.
	 * @param jobID The if of the <code>Job</code> to be executed.
	 * @throws UnknownIDException if the jobID is unknown to the <code>JobRegistry</code>. 
	 * @throws NullPointerException if <code>jobID</code> is <code>null</code>
	 */
	 ...
	 * @param shemaFile - the <code>File</code>.
