 ...
 * <p>
 * During registration older pluginversions are automaticly replaced by 
 * newer versions.
 * </p>
 * @author Christian Gerhardt <case42@gmx.net>
 */
public class PluginRegistry<P extends IPlugin> extends Registry<P> implements IPluginRegistry<P> {

	
	/* (non-Javadoc)
	 * @see org.dotplot.core.plugins.IPluginRegistry#registerPlugin(P)
	 */
	public P register(String id, P plugin) throws DuplicateRegistrationException {
		if(plugin == null){
	 ...
	 */
	public void combine(IRegistry<P> registry) throws DuplicateRegistrationException {
