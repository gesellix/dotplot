...
/**
 * Instances of this class are <code>Services</code> to integrate <code>Plugins</code> into the <code>PluginContext</code>.
 * <p>
 * This <code>Service</code> is second in the line of pluginloading. 
 * Its purpose is to integrate the loaded plugins into the 
 * <code>PluginContext</code> by using 
 * {@link org.dotplot.core.plugins.IPluginContext#installPlugin(P)}.
 * </p>
 * <hr>
 * 	<h2>Workingcontext</h2>
 * 	{@link org.dotplot.core.plugins.IPluginListContext}
 * <hr>
 * 	<h2>Hotspots</h2>
 * 	none
 * <hr>
...
public class PluginIntegrationService extends PlugableService<IPluginContext> {
	...
	public ITask createTask() {
		...
		if(this.frameworkContext instanceof NullContext){
			this.getErrorHandler().fatal(this,new PluginException("framework is missing"));
			return null;
		}

		if(this.getWorkingContext() instanceof NullContext){
			this.getErrorHandler().fatal(this, new PluginException("workingcontext is missing"));
			return null;
		}

		Collection<? extends IPlugin> plugins = (Collection<? extends IPlugin>) ((IPluginListContext)this.getWorkingContext()).getPluginList();
			
		ITaskPart part = new PluginIntegrationTaskPart("Part 1", plugins, this.frameworkContext);
