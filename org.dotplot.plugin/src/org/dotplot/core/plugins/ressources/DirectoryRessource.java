...
public class DirectoryRessource implements IRessource {
	 ...
	 * @throws NullPointerException if directory is <code>null</code>
	...
	/**
	 * Creates a new <code>DirectoryRessource</code>.
	 * @param path of the represented directory.
	 * @throws NullPointerException if directory is <code>null</code>
	 * @throws IllegalArgumentException if directory is not a directory. 
	 */
	...
	/**
	 * Sets the directory.
	 * @param file The dirextory to be set.
