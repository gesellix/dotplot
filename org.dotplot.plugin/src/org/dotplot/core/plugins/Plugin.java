...
public class Plugin implements IPlugin {
	...
	/**
	 * The <code>ServiceManager</code> to register the <code>Services</code> to the plugin.
	 */
	 ...
	 * The id is also used as name of the <code>Plugin</code>.
	 * </p> 
	 * @param id - the plugin id.
	 * @param version - the plugin version.
	 */
	public Plugin(String id, String version) {
		if(id == null || version == null) throw new NullPointerException();
		init(id, id, version,"","");
	}
	...
	public Plugin(String id, String name, String version){
		if(id == null || name == null || version == null) throw new NullPointerException();
	 ...
	 */
	public Plugin(String id, String name, String version, String provider, String info){
		if(id == null|| name == null || version == null) throw new NullPointerException();
	 ...
	 * @param info - information about the plugin.
	 */
	private void init(String id, String name, String version, String provider, String info){
		this.id = id;
		this.name = name;
		try {
	...
	public void storeExtention(String serviceID, String hotSpotID,Extention extention) {
		if(serviceID == null || hotSpotID == null || extention == null) throw new NullPointerException();
	...
	/* (non-Javadoc)
	 * @see org.dotplot.core.plugins.IRegistry#combine(org.dotplot.core.plugins.IRegistry)
	 */
	public void combine(IRegistry<IJob> registry) throws DuplicateRegistrationException {
