...
/**
 * Instances of this class are <code>FrameworkContext</code> for the plugin-framework.
...
public interface IPluginContext<P extends IPlugin> extends IFrameworkContext {
	...
	/**
	 * Returns the path of the pluing directory.
	 * Plugins are stored in this directory.
	 ...
	 * </p>
	 * @param plugin - the <code>Plugin</code> to be installed
	 * @throws DuplicateRegistrationException 
	 * 	if a <code>Plugin</code> with the specified id is allready installed.
	 */
