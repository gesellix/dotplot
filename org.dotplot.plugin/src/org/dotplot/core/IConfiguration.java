...
/**
 * This interface serves as supertype of all configurations used in the dotplot system.
...
public interface IConfiguration {
	 ...
	 * <p>
	 * The copy must be independent to the original, so that modifieing
	 ...
	 * </code>
	 * </p>
	 * @param serivalizedForm The serialized form of a <code>Configuration</code>
