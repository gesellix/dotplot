...
public interface IDotplot {
     ...
     */
    public static final String[] STEPS = { "Init...",
	    "Allocating image buffer", "Setting background...",
	    "Reading matches", "Scaling", "Color conversion",
     ...
     * 
     * @param roi
     *            a Rectangle object specifying the ROI value
     * @param imgData
     *            a link to the currently displayed image
     * 
    ...
    /**
     * Lets the Dotplot return a representation of the internal image, using the
     * desired class type. If the given class type does not exist,
     * <code>null</code> will be returned.
     * 
     * @param imageClass
     *            one of the supported class types
     * 
     ...
     * 
     * @param size
     *            a Dimension object specifying the target size value
     * 
