 ...
 */
public interface IService<F extends IFrameworkContext, S extends IServiceHotSpot> extends ExecutionUnit{
	public String getID();
	 ...
	 * <code>Service</code>.
	 * In normal cases the invokation takes place after <b>all</b>
	 * <code>Extentions</code> had bin added.
	 * </p>  
	 */
	public void init();
	 ...
	 * </p>
	 * @return - A <code>NullContext</code>-object befor invoking of <code>run()</code>,
	 * and a resultcontext afterwards.
	 */
	public IContext getResultContext();
	
	/**
	 * Should not return <i>null</i>, use <code>NullContext.class</code> instead!
	 * @return
	 */
	 ...
	 * @throws IllegalArgumentException - if the extention is invalid
	 */
