...
public abstract class AbstractTaskPart implements ITaskPart {
	...
	/**
	 * A <code>Collection</code> to administer the <code>TaskPart</code>'s ressources.
	 */
	 ...
	 * @throws NullPointerException if ressources is <code>null</code>.
	 */
	public void setRessources(Collection<? extends IRessource> ressources){
		if(ressources == null) throw new NullPointerException();
	...
	/*
	 *  (non-Javadoc)
	 * @see org.dotplot.core.services.ITaskPart#setErrorHandler(org.dotplot.core.services.IErrorHandler)
	 */
