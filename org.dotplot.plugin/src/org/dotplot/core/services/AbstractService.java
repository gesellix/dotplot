 ...
 */
public abstract class AbstractService<F extends IFrameworkContext, S extends IServiceHotSpot>
	implements IService<F, S> {
	...
	if (hotSpotID == null || extention == null) {
	    throw new NullPointerException();
	}
    ...
    public void addExtention(String hotSpotID,
	    ...
	    throws UnknownServiceHotSpotException {
	if (hotSpotID == null || plugin == null || extentionObject == null) {
	    throw new NullPointerException();
	}
     ...
     * 
     * @param hotSpot
     *            - the <code>ServiceHotSpot</code> to add.
     */
	...
	if (spot == null) {
	    throw new UnknownServiceHotSpotException(id);
	}
	return spot;
    }
     ...
     * (non-Javadoc)
     * 
     * @seeorg.dotplot.services.IService#setErrorHandler(org.dotplot.services.
     ...
     * 
     * @see
     * org.dotplot.services.IService#setFrameworkContext(org.dotplot.services
     * .FrameworkContext)
     */
     ...
     * 
     * @see
     * org.dotplot.services.IService#setWorkingContext(org.dotplot.services.
     * IContext)
     */
    public void setWorkingContext(IContext workingContext)
