...
public class Task implements ITask {
	 ...
	 * @param id The id of the <code>Task</code>.
	 * @param marshaler The <code>TaskResultMarshaler</code> of the <code>Task</code>.
	 * @param partable Indicator if the <code>Task</code> is partable.
	 */
	public Task(String id, ITaskResultMarshaler marshaler, boolean partable) {
		if(id == null || marshaler == null) throw new NullPointerException();
		this.done = false;		
