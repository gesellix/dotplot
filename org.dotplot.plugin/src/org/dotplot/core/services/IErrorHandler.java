...
public interface IErrorHandler {
	 ...
	 * Handles an error.
	 * <p>
	 * A error is usualy unexpected and interupts the program, which
	 * need further processing, if it should resume its work or not.
	 * </p> 
	 * @param t The source of the error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * immediately.
	 * </p>
	 * @param t The source of the fatal error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * Handles a warning.
	 * <p>
	 * A warning is usualy no problem for the programm, but a note for
	 * the user.
	 * </p>
	 * @param t The source of the warning.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * need further processing, if it should resume its work or not.
	 * </p> 
	 * @param s The source of the error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * immediately.
	 * </p>
	 * @param s The source of the fatal error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * the user.
	 * </p>
	 * @param s The source of the warning.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * need further processing, if it should resume its work or not.
	 * </p> 
	 * @param j The source of the error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * immediately.
	 * </p>
	 * @param j The source of the fatal error.
	 * @param e The <code>Exception</code> which caused the error.
	 */
	 ...
	 * the user.
	 * </p>
	 * @param j The source of the warning.
	 * @param e The <code>Exception</code> which caused the error.
	 */
