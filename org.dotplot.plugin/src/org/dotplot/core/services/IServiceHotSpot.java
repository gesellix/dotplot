...
public interface IServiceHotSpot {
	 ...
	 * 
	 * @param extention
	 *            - the <code>Extention</code> to be added
	 * @throws IllegalArgumentException
	 *             - if the <code>Extention</code> is invalid
	 */
	public void addExtention(Extention extention);

	/**
	 * Returns a <code>Collection</code> of the avtivated
	 * <code>ServiceExtentions</code> of the <code>ServiceHotSpot</code>.
	 * <p>
	 * An <code>Extention</code> get its activated state from its assigned
	 * <code>ServiceExtentionActivator</code>.
	 * </p>
	 * 
	 * @return A <code>Collection</code> of all avtivated
	 *         <code>ServiceExtentions</code>.
	...
	/**
	 * Returns a <code>Collection</code> of the avtivated objects of the
	 * <code>ServiceExtentions</code> of the <code>ServiceHotSpot</code>.
	 * <p>
	 * An <code>Extention</code> get its activated state from its assigned
	 * <code>ServiceExtentionActivator</code>.
	 * </p>
	 * 
	 * @return A <code>Collection</code> of the objects of all avtivated
	 *         <code>ServiceExtentions</code>.
	 * @see IServiceExtentionActivator
	 */
	 ...
	 * <code>ServiceHotSpot</code>.
	 * 
	 * @param extention
	 *            The <code>Extention</code> to be checked.
	 * @return <code>true</code> if the <code>Extention</code> is valid,
