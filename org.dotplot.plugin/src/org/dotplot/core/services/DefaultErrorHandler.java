...
public class DefaultErrorHandler implements IErrorHandler {
     ...
     *            The errormessage.
     * @param grade
     *            The grade of the error.
     */
    private void addErrorMessage(String sourceType, String sourceID,
	    String errorType, String errorMessage, String grade) {
	if (errorMessage == null) {
	    errorMessage = "no message";
	}
	this.errorCounter++;
	this.errorMessages.append(String.format("[%d]%s(%s) at %s:%s -> %s\n",
		new Object[] { this.errorCounter, errorType, grade, sourceType,
     ...
     * 
     * @see
     * org.dotplot.core.services.IErrorHandler#error(org.dotplot.core.services
     * .IJob, org.dotplot.core.services.ServiceException)
     */
     ...
     * @see
     * org.dotplot.core.services.IErrorHandler#error(org.dotplot.core.services
     * .IService, org.dotplot.core.services.ServiceException)
     */
     ...
     * @see
     * org.dotplot.core.services.IErrorHandler#error(org.dotplot.core.services
     * .ITaskPart, org.dotplot.core.services.ServiceException)
     */
    public void error(ITaskPart t, Exception e) {
	this
		.addErrorMessage("TaskPart", t.getID(), "", e.getMessage(),
			"error");
    }
     ...
     * @see
     * org.dotplot.core.services.IErrorHandler#error(org.dotplot.core.services
     * .ITaskProcessor, org.dotplot.core.services.ServiceException)
     */
    public void error(ITaskProcessor t, Exception e) {
	this.addErrorMessage("TaskProcessor", "no id", "", e.getMessage(),
		"error");
    }
     ...
     * 
     * @see
     * org.dotplot.core.services.IErrorHandler#fatal(org.dotplot.core.services
     * .IJob, org.dotplot.core.services.ServiceException)
     */
     ...
     * 
     * @see
     * org.dotplot.core.services.IErrorHandler#warning(org.dotplot.core.services
     * .IJob, org.dotplot.core.services.ServiceException)
     */
	...
	this.addErrorMessage("Service", s.getID(), "", e.getMessage(),
		"warning");
    }
	...
	this.addErrorMessage("TaskPart", t.getID(), "", e.getMessage(),
		"warning");
    }
