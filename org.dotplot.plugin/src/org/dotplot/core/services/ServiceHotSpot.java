...
public class ServiceHotSpot implements IServiceHotSpot {
     ...
     * 
     * @param id
     *            - the if fd the <code>ServiceHotSpot</code>.
     ...
     * 
     * @see
     * org.dotplot.services.IServiceHotSpot#addExtention(org.dotplot.services
     * .Extention)
     */
	...
	if (!this.isValidExtention(extention)) {
	...
	Vector<Extention> activeExtentions = new Vector<Extention>(
		this.extentions.size());
     ...
     * 
     * @see
     * org.dotplot.services.IServiceHotSpot#getObjectsFromActivatedExtentions()
     */
    public Collection<Object> getObjectsFromActivatedExtentions() {
	Extention[] extentions = this.getActiveExtentions().toArray(
		new Extention[0]);
     ...
     * 
     * @see
     * org.dotplot.services.IServiceHotSpot#removeExtention(org.dotplot.services
     * .Extention)
     */
