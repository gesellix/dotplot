...
public class SelectTokenizerController extends ViewController {
	 ...
	 */
	private static Logger logger = Logger.getLogger(SelectTokenizerController.class
			.getName());
	...
	public void update(Observable o, Object arg) {
		if (o instanceof SelectTokenizerView) {
			...
			converterConfig.setConvertedFilesDirectory(stsv.getConversionDirectory());
			converterConfig.setKeepConvertedFiles(stsv.getKeepConvertedFilesState());									
		}
	}
}
