...
public class TokenizerTaskPart extends AbstractTaskPart {
	...
	public TokenizerTaskPart(String id, ITokenizer tokenizer) {
		super(id);
		if(tokenizer == null) throw new NullPointerException();
	 ...
	 */
	public void setLocalRessources(Collection<? extends IRessource> ressourceList)
			throws InsufficientRessourcesException {
		if(ressourceList == null) throw new InsufficientRessourcesException("ressourcelist is null");
