...
public class TokenFilterContainer extends BaseTokenFilter {
	...
	/**
	 * Creates a<code>TokenFilterContainer</code>. A Container for
	 * TokenFilter. Every Token wich will be scanned are handled throught every
	 * Tokenfilter in this Container.
	 */
	...
	/**
	 * Creates <code>TokenFilterContainer</code>. A Container for
	 * TokenFilter. Every Token wich will be scanned are handled throught every
	 * Tokenfilter in this Container.
	 * 
	 * @param tokenStream
