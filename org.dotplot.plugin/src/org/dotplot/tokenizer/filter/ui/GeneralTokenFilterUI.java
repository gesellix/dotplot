...
public class GeneralTokenFilterUI extends AbstractFilterUI {
	...
	protected void drawTypeList(Composite parent, SelectionListener changeListener) {
		parent.setLayout(new GridLayout(1, true));

		this.checkBoxes = new TokenTypesCheckBox[this.tokentypes.length];

		this.createGroup(parent, "keywords", TokenType.KIND_KEYWORD,changeListener);
		this.createGroup(parent, "operators", TokenType.KIND_OPERATOR,changeListener);
		this.createGroup(parent, "punctuation marks",
				TokenType.KIND_PUNCTUATION_MARK,changeListener);
		this.createGroup(parent, "other tokens", TokenType.KIND_OTHER,changeListener);
	}
	 ...
	 */
	private void createGroup(Composite parent, String name, int tokenKind, SelectionListener changeListener) {
		Group g = null;
		boolean first = true;
