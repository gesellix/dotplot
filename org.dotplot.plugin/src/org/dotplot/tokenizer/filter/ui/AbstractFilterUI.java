...
public abstract class AbstractFilterUI implements IFilterUI {
	...
	public abstract Control drawContent(Composite parent, SelectionListener changeListener);
	
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.filter.ui.IFilterUI#setFilterID(java.lang.String)
	 */
	...
	/*
	 *  (non-Javadoc)
	 * @see org.dotplot.tokenizer.filter.ui.IFilterUI#setSourceType(org.dotplot.core.ISourceType)
	 */
