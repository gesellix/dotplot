...
public class SentenceFilterUI extends AbstractFilterUI {
	...
	public Control drawContent(Composite parent,
		...
		bSentences.setToolTipText("activate the sentence filter");
	...
	public TokenType getSelectedPunktuationMark() {
		if (this.punctuationCombo != null
				&& !this.punctuationCombo.isDisposed()) {
	...
	public boolean isSentenceFilter() {
		if (this.sentenceCheckBox != null
				&& !this.sentenceCheckBox.isDisposed()) {
