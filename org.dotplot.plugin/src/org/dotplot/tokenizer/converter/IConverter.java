...
public interface IConverter {
	...
	/**
	 * Converts a <code>PlotSource</code> into another <code>SourceType</code> specified by this <code>Converter</code>.
	 * @param source - the <code>PlotSource</code> to be converted.
	 ...
	 * Converts a <code>PlotSource</code> into another <code>SourceType</code> specified by this <code>Converter</code>.
	 * @param source - the <code>PlotSource</code> to be converted.
	 * @param directory - The directory in which the converted <code>PlotSource</code> should be saved in.
	 * @return the <code>PlotSource</code> containing the converted data.
	 * @throws IOException - if an io-problem occures.
	 * @throws NullPointerException - if argument is <code>null</code>.
	 */
	 ...
	 * <p>
	 * The sourcetype indicates which types of data the converter
	 * could convert.
	 * </p>
	...
	/**
	 * Sets if an existing converted <code>PlotSource</code> should be overwritten.
	 * @param overwrite <code>true</code> if the converted <code>PlotSource</code> should be overwritten, <code>false</code> otherwise.
	 */
