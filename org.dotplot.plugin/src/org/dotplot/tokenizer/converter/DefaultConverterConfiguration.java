...
public class DefaultConverterConfiguration implements IConverterConfiguration {
	 ...
	 * @param convertedDirectory The convertedDirectory to set.
	 */
	public void setConvertedFilesDirectory(File convertedDirectory) {
		if(convertedDirectory != null){
			if(! (  convertedDirectory.exists() &&  convertedDirectory.isDirectory())){
				throw new IllegalArgumentException(convertedDirectory.getAbsolutePath());
			}
		}
	...
	/*
	 *  (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#setKeepConvertedFiles(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#overwriteConvertedFiles()
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#getCovertedFilesDirectory()
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#getTargetType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#getConverterID(org.dotplot.core.ISourceType)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#keppConvertedFiles()
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#setConverter(org.dotplot.core.ISourceType, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#setConvertFiles(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.dotplot.tokenizer.converter.IConverterConfiguration#getConvertFiles()
	 */
	 ...
	 */
	public IConfiguration objectForm(String serializedForm) throws UnsupportedOperationException {
		if(serializedForm == null) throw new NullPointerException();
		...
		try{
			...
			if(tokenizer.hasMoreTokens()) throw new IllegalArgumentException();
