 ...
 * <p>
 * This <code>Action</code> could be used to execute a job by using the
 * eclipse userinterface. In this way menuentries or popupmenus could 
 * execute <code>Job</code>s. 
 * </p> 
...
public class JobAction extends Action {
	 ...
	 * @param text - label of the <code>Action</code>.
	 * @param jobID - the if og the executed <code>Job</code>.
	 */
