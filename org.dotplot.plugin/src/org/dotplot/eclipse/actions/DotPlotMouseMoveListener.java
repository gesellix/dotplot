...
class DotPlotMouseMoveListener implements MouseMoveListener
{
   ...
   public DotPlotMouseMoveListener(
         IWorkbenchWindow parent, ImageData imgData, DotPlotter plotter, float scale)
   {
   ...
   public void mouseMove(MouseEvent event)
   {
      ...
      try {
    	  roiResult = Util.getDetailsForLoc(location, new Dimension(imageData.width, imageData.height), scale, ContextFactory.getContext().getCurrentTypeTable().createNavigator());
		}
		catch(Exception e){
			roiResult = null;
		}
