...
public class DotplotPreferenceInitializer extends AbstractPreferenceInitializer {
	 ...
	 */
	private static Logger logger = Logger.getLogger(DotplotPreferenceInitializer.class
			.getName());
	...
	public void initializeDefaultPreferences() {
		...
		IEclipsePreferences node = new DefaultScope().getNode(EclipseConstants.ID_PLUGIN_DOTPLOT);
