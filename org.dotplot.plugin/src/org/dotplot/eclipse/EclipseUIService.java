...
/**
 * Tasks of this <code>Service</code> do nothing, the workingcontext is
 * passed untouched as resultcontext.
 * 
 * <hr>
 ...
 * <p>
 * <b>Hotspot:</b> View<br>
 * <b>Extention:</b> {@link org.dotplot.ui.configuration.views.ConfigurationView}<br>
 * <b>Parameter:</b><br>
 * <br>
 * <b>Info:</b><br>
 * </p>
...
public class EclipseUIService extends DotplotService implements IGuiService{
	...
	private class MenuEntry{
		 ...
		 * @param id - the id of the <code>MenuEntry</code>..
		 * @param text - the text of the <code>MenuEntry</code>..
		 */
	...
	public void init(){
		...
		if(this.frameworkContext instanceof DotplotContext){
			((DotplotContext)this.frameworkContext).setGuiServiceID(this.getID());
		}
			...
			for(Extention e : extentions){
				...
				if(id != null && name != null){
					if(menu == null){
						...
						if(! this.menus.containsKey(id))	this.menus.put(id, entry);
					}
					else {
		...
		try {
			...
			for(Extention e : extentions){
				id = e.getParameter("id");
				if(id != null){
					ConfigurationView view = (ConfigurationView)e.getExtentionObject();
	...
	public void fillMenuBar(IMenuManager menuBar){
		...
		for(MenuEntry entry : this.menus.values()){
			if(entry.parent == null){
				...
				try{
					//on first call, the menus from the plugin.xml aren't created yet,
					//so this id is unknown at that time.
					menuBar.insertBefore(EclipseConstants.ID_MENU_DOTPLOT,menu);
				}
	 ...
	 * @param text - text on the end of the generated id
	...
	/* (non-Javadoc)
	 * @see org.dotplot.core.IGuiService#showErrorMessage(java.lang.String, java.lang.String)
	 */
