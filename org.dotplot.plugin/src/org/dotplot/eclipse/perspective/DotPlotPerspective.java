package org.dotplot.eclipse.perspective;
...
/**
 * <code>DotPlotPerspective</code> is the perspective that provides all
 * Dotplot-related views and actions.
 * 
...
public class DotPlotPerspective implements IPerspectiveFactory {
     ...
     */
    public static final String DOTPLOTTER = new String(
	    "org.dotplot.plugin.view1");

    /**
     * <code>DOTPLOTNAV</code> Name that references the DotPlot Navigator view.
     */
    public static final String DOTPLOTNAV = new String(
	    "org.dotplot.plugin.view2");

    /**
     * <code>DOTPLOTLIST</code> Name that references the DotPlotLister view.
     */
    public static final String DOTPLOTLIST = new String(
	    "org.dotplot.plugin.view3");
