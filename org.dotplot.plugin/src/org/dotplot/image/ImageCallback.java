...
/**
 * <code>ImageCallback</code> links the image calculation engine(s)
 * to the target image. This way it is possible to exchange the format
 * (class type) of the target without changing the underlying algorithm.
 *
...
interface ImageCallback
{
    ...
    *
    * @param diff    Progress (in percent) since last update
