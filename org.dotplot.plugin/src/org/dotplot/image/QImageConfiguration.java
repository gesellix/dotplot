...
public class QImageConfiguration implements Serializable, IQImageConfiguration {
	...
	public QImageConfiguration() {
		this(false, JAITools.JPG, "/dotplot", true, "inverted_gray", null, null, 1,true,true,true);		
//		// Do Export
...
//		setUseInformationMural(true);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setExportDotplotToFile(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setExportFilename(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setLutBackground(java.awt.Color)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setLutForeground(java.awt.Color)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setShowFileSeparators(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dotplot.image.IQImageConfiguration#setUseInformationMural(boolean)
	 */
	...
	public IConfiguration copy() {
		return new QImageConfiguration(
				this.isExportDotplot,
				this.exportFormat,
				this.exportFilename,
				this.useLUT,
				this.lutTitle,
				this.getLutBackground(),
				this.getLutForeground(),
				this.scaleMode,
				this.doScaleUp,
				this.showFileSeparators,
				this.useInfoMural
				);
	}
