 ...
 * org.eclipse.swt.widgets.Canvas, and can be used in any context
 * that calls for a Canvas.
 *
...
public final class Colorbar extends Canvas
{
    ...
    * http://help.eclipse.org/help21/index.jsp?topic=/org.eclipse.platform.doc.isv/guide/swt_widgets_custom.htm
    *
    ...
    *
    * @param newlut the LUT to display
    */
    ...
    *
    * @param color a valid RGB object
    *
   ...
   {
      return new RGB(lut[0][lut[0].length - 1], lut[1][lut[1].length - 1], lut[2][lut[2].length - 1]);
   }
    ...
    * Records a new size.
    *
    * @param w the new width for the receiver
    * @param h the new height for the receiver
    */
