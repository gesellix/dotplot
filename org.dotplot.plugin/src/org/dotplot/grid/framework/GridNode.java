...
/**
 * Common Node in our Grid. Provides an <code>Identity</code> and can be notified about messages
 */
abstract class GridNode
{
   ...
   public abstract boolean notify(String tag, Object data, Identity src) throws IOException;
}
