...
{
   private final static Logger logger = Logger.getLogger(Mediator.class.getName());
    ...
    * @param to     receiver
    * @param fromID sender
    * @param mtag   label for the message
    * @param obj    data
    *
    * @return success
    *
   ...
   public boolean send(Identity to, Identity fromID, String mtag, Object obj)
         throws IOException
   {
      logger.debug("mm: sending message \"" + mtag + ", " + obj + "\" to " + to);
   ...
   public boolean notify(String tag, Object data, Identity src) throws IOException
   {
      ...
      if (tag.equals(Message.MSG_IDENTITY_NAME))
      {
