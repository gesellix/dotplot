...
public class Main
{
   ...
   private static void showHelp()
   {
      ...
      System.out.println("java " + Main.class.getName() + "[[-mediator [port]] | [<name> <host> <port>]]");
      System.out.println();
      System.out.println("To start the mediator/server, don't pass any arguments or use '-mediator'");
      System.out.println("To start the collaborator, give it's name and host/port of mediator");
   }
   ...
   private static void startCollaborator(String name, String host, int port)
   {
      ...
      while (c.getIdentity() == null) ; // wait for ID
