 ...
 * <p />
 * (C) by Friederich Kupzog Elektronik & Software Köln
 * All rigths reserved.
 */
public class ToolTip implements Listener
{
   ...
   /**
    * Konstruktor. Legt einen neuen ToolTip zum Control control an.
    * Die Instanziierung genügt, der Tip registriert sich
    * als Listener selbst beim control.
    *
