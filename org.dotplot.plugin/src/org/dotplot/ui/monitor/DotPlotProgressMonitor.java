...
/**
 * <code>DotPlotProgressMonitor</code> is a Singleton that manages the DotPlotProgressDialog.
 *
...
public class DotPlotProgressMonitor implements SelectionListener
{
   ...
   /**
    * <code>DotPlotProgressMonitor</code> is a Singleton. Use <code>getInstance</code> to access it.
    *
    ...
    *
    * @param plotUnit your PlotUnit (most likely a controller) that can tell its progress
    *
...
//      }
    ...
    * starts a new dialog.
    *
    * @param maxUnits number of modules to monitor
    */
   ...
   /**
    * use this to tell the monitor you have worked an amount
    * it will ask your unit for messages and percentage of work done.
    */
   public void update()
   {
      if (!isUnderControl)
      ...
      dialog.step(unit.getProgress() / units + (100 / units) * unitsControlled);
